 ...
 */
package com.idega.block.facebook.client.business;
 ...
 */
public interface FacebookLoginService extends OAuth2LoginService{

	public static final String BEAN_NAME = "facebookLoginService"; 
	
	/**
	 * 
	 * <p>Method to login to facebook.com</p>
	 * @param accessToken is password of account in facebook.com, 
	 * not <code>null</code>;
	...
	/**
	 * 
	 * <p>Checks if login to facebook.com is successful, if <code>true</code>
	 * then searches for matching idega {@link com.idega.user.data.User}, 
	 * creates if not found and logins it.</p>
	 * @param accessToken to verify that login is successful and access
	 * facebook.com {@link User} data, not <code>null</code>;
	 * @return logged in idega {@link com.idega.user.data.User} or 
	 * <code>null</code> on failure;
	 * @author <a href="mailto:martynas@idega.com">Martynas Stakė</a>
	 */
	...
	/**
	 * 
	 * @return id of attached facebook.com application to system, which is
